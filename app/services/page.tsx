...
export function generateMetadata(): Metadata {
  /* Раньше тайтл был «Аквазона и услуги — апартаменты с бассейном в Алуште»
     и шёл ровно на тот же запрос, что новая посадочная /zhile-s-basseynom.
     Две свои страницы в одной выдаче делят сигналы и мешают друг другу,
     поэтому коммерческое «жильё с бассейном» отдано посадочной, а эта
     остаётся про сервис: что входит, что можно заказать. */
  const title = 'Аквазона, сервис и услуги для гостей';
  const description =
  ...
  return {
    ...
    openGraph: {
      ...
      /* JPEG 1200×630, а НЕ исходный webp: Telegram/WhatsApp/VK не показывают
         WebP в превью ссылок — карточка приходит без картинки. Пропорция 1200×630
         тоже обязательна, иначе превью обрежет кадр как попало. */
      images: [
        {
