...
const PRESET_FEATURES: { label: string; icon: string }[] = [
  // Ванная
  { label: 'Собственная ванная комната', icon: '🚿' },
  { label: 'Ванна', icon: '🛁' },
  { label: 'Душевая кабина', icon: '🚿' },
  // Кухня
  { label: 'Отдельная кухня', icon: '🍳' },
  { label: 'Кухонная зона', icon: '🍳' },
  { label: 'Wi-Fi', icon: '📶' },
  { label: 'Большой холодильник', icon: '🧊' },
  { label: 'Холодильник', icon: '🧊' },
  { label: 'Микроволновая печь', icon: '📦' },
  { label: 'Духовой шкаф', icon: '🔲' },
  { label: 'Индукционная варочная панель', icon: '🔥' },
  { label: 'Посудомоечная машина', icon: '🫧' },
  { label: 'Вытяжка', icon: '💨' },
  { label: 'Набор посуды', icon: '🍽️' },
  { label: 'Столовые приборы', icon: '🍽️' },
  { label: 'Электрический чайник', icon: '☕' },
  { label: 'Кофеварка капельная', icon: '☕' },
  { label: 'Кофемашина', icon: '☕' },
  { label: 'Обеденный стол', icon: '🪑' },
  { label: 'Стулья', icon: '🪑' },
  { label: 'Консольный столик', icon: '🪑' },
  { label: 'Компьютерный столик', icon: '💻' },
  // Кровати
  { label: 'Кровать Queen-size 160 × 200', icon: '🛏️' },
  { label: 'Кровать King-size 180 × 200', icon: '🛏️' },
  { label: 'Раскладное кресло 90 × 200', icon: '🛋️' },
  { label: 'Односпальная кровать 90 × 200', icon: '🛏️' },
  { label: 'Раскладной двухместный диван 200 × 200', icon: '🛋️' },
  // Хранение
  { label: 'Гардеробная зона', icon: '🚪' },
  { label: 'Шкаф', icon: '🚪' },
  // Глажка/стирка
  { label: 'Доска гладильная', icon: '👔' },
  { label: 'Утюг', icon: '👔' },
  { label: 'Сушилка для белья напольная', icon: '🔄' },
  { label: 'Стиральная машинка', icon: '🔄' },
  // Электроника
  { label: 'SMART TV', icon: '📺' },
  ...
  { label: 'Кресло-кокон', icon: '🪑' },
  { label: 'Шезлонг', icon: '🌊' },
  // По запросу
  { label: 'Раскладушка по запросу', icon: '🛏️' },
  { label: 'Матрас по запросу', icon: '🛏️' },
  // Активный отдых
  { label: 'Палки для треккинга', icon: '🥾' },
  { label: 'Надувной матрас', icon: '🏖️' },
  { label: 'Надувное кресло', icon: '🏖️' },
  // Для детей
  { label: 'Манеж', icon: '👶' },
  // Расположение
