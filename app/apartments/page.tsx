 ...
 *
 * Число апартаментов — метка APARTMENTS_LABEL («более 55»), а НЕ COUNT(*) из БД:
 * по словам владельца, в комплексе более 55 апартаментов; в каталоге сайта
 * 47 карточек. Динамический COUNT(*) отражал бы число карточек, а не реальный
 * объём комплекса — поэтому константа.
