...
export function generateMetadata(): Metadata {
  ...
  const description =
    'Жильё в Профессорском уголке Алушты посуточно: более 55 апартаментов на Западной улице, до пляжа 650 м пешком. Бассейны круглый год, аквазона, вид на море. Бронирование напрямую, без комиссии посредников.';
    ...
    <main className="lp-page">
      ...
      <header className="lp-hero">
        ...
        <div className="lp-hero-inner">
          ...
          <p className="lp-hero-subtitle">
            Апарт-отель «Стиль Жизни» на Западной улице — более 55 апартаментов в тихой части города
      ...
      <section className="lp-section lp-section-alt">
        <div className="lp-inner">
          ...
          <h2 className="lp-title lp-reveal">Более 55 апартаментов в 650 метрах от моря</h2>
          <div className="lp-prose lp-reveal">
            <p>
              ...
              до пяти человек. Больше половины апартаментов — с окнами на море, почти в каждом
